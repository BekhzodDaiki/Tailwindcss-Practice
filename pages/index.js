      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between dark:text-white">
            <h1 className="font-burtons text-xl">Beka</h1>
        ...
        <section>
          ...
          <div className="lg:flex gap-10">
            <div className={commonStyle.cardContainer}>
              ...
              <p className={commonStyle.textGray800PY1}>Photoshop</p>
              <p className={commonStyle.textGray800PY1}>Illustrator</p>
              <p className={commonStyle.textGray800PY1}>Figma</p>
